...
FONTS_PATHS = {
    ...
    "Pandora_Rogtars": os.path.join(
        BASE_PATH, "../resources/fonts/Pandora_Rogtars.otf"
    ),
}
...
PATHS = {
    ...
    "mathjax_path": "http://localhost:8000/resources/mathjax/MathJax-4.0.0-beta.7/tex-mml-chtml.js",
}
